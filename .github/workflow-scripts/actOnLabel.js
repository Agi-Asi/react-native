...
module.exports = async (github, context, labelWithContext) => {
  ...
  switch (labelWithContext.label) {
    ...
    case 'Type: Docs':
      await addComment(
        `> [!NOTE]\n` +
          `> **Docs issue**: This issue looks like an issue related to our docs. Please report documentation issues in the [react-native-website](https://github.com/react/react-native-website/issues) repository.`,
      );
      await closeIssue();
      return;
    case 'Type: Expo':
